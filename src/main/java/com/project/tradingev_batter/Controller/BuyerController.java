...
public class BuyerController {
    ...
    //NOTE: API POST /request-seller-upgrade đã được chuyển sang /api/client/request-seller-upgrade
    //Buyer nên dùng API /api/client/request-seller-upgrade để gửi yêu cầu nâng cấp
